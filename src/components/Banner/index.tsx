 ...
 * @returns { React.ReactElement} - Section Bannière
 */
export default function Banner(): React.ReactElement {
    ...
    return (
        <section className="banner d-flex flex-column" >
            {/*  Contenu de Banner */}
            <Row className="banner__title d-flex flex-column justify-content-center align-items-center text-white text-center ">
            ...
            {/* Liens */}
            <div className="banner__links d-flex flex-row-reverse gap-3  ">
                <IconButton
                    label="github"
                    icon={
